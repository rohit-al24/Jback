...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'mastered'], name='course_user_user_id_9a6e8b_idx'), models.Index(fields=['user', 'due_at'], name='course_user_user_id_b845f9_idx'), models.Index(fields=['user', 'is_weak'], name='course_user_user_id_5a05e3_idx')],
